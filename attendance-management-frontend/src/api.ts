...
export const checkSession = async () => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/auth/check-user`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const getAttendanceByUserId = async (id: string) => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/admin/attendance/${id}`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const searchUserFromAdmin = async (searchTerm: string) => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/admin/search?q=${searchTerm}`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const getDailyAttendance = async () => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/admin/attendance/daily`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const getAllAttendance = async () => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/attendance/report?limit=10`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const getAllAttendanceReport = async (year, month) => {
  try {
    const response = await axios.get(
      `${API_URL}api/v1/attendance/report?type=monthly&year=${year}&month=${month}`,
      axiosConfig
    );
    return response.data;
  } catch (error) {
...
export const setOutTimeAttendance = async (data) => {
  ...
  try {
    ...
    const response = await axios.patch(
      `${API_URL}api/v1/attendance/out/${data.attendance_id}`,
      { out_time },
      axiosConfig
    );
    return response.data;
