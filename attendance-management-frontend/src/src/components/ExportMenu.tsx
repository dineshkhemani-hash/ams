...
const ExportMenu: React.FC<ExportMenuProps> = ({ records, fileName = 'attendance' }) => {
          ...
          <Table>
            ...
            ${records.map(record => `
              <Row>
                ...
                <Cell><Data Type="String">${record?.user?.name || record?.name}</Data></Cell>
                <Cell><Data Type="String">${record.in_time}</Data></Cell>
                <Cell><Data Type="String">${record.out_time || '--'}</Data></Cell>
                <Cell><Data Type="Number">${record.duration || '--'}</Data></Cell>
              </Row>
            `).join('')}
          </Table>
        </Worksheet>
